...
source "proxmox-iso" "rocky-linux-10" {
  ...
  boot_iso {
    type             = "ide"
    iso_url          = "https://dl.rockylinux.org/pub/rocky/10/images/x86_64/Rocky-10-GenericCloud-Base.latest.x86_64.qcow2"
    iso_checksum     = "file:https://dl.rockylinux.org/pub/rocky/10/images/x86_64/CHECKSUM"
    iso_storage_pool = var.proxmox_iso_storage_pool
    iso_target_path  = "${var.iso_cache_dir}/Rocky-10-GenericCloud-Base.latest.x86_64.qcow2"
    unmount          = true
  }
