...
source "proxmox-iso" "ubuntu-25-10" {
  ...
  boot_iso {
    type         = "ide"
    iso_file     = "${var.proxmox_iso_storage_pool}:iso/packer-ubuntu-25.10-live-server-amd64.iso"
...
build {
  sources = ["source.proxmox-iso.ubuntu-25-10"]
